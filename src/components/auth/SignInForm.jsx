...
export default function Login() {
  ...
  return (<div className="relative w-full flex items-center justify-center font-sans overflow-hidden dark">
      ...
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
        ...
        <div className="grid grid-cols-3 gap-2">
         <button onClick={() => alert("Apple Login Not Implemented")} className="provider-btn"><AppleIcon /></button>
          <button onClick={handleGoogleLogin} className="provider-btn"><GoogleIcon /></button>
          <button onClick={() => alert("X Login Not Implemented")} className="provider-btn"><XIcon /></button>
        </div>
  ...
  className="
    ...
    px-3 py-2 pr-10 text-sm shadow-sm 
